...
All rights reserved.
# https://github.com/jiangtaoxie/fast-MPN-COV/blob/master/finetune/finetune.sh
# https://github.com/jiangtaoxie/fast-MPN-COV/blob/c430c781264b7ce77536493308b09d73d534ce7a/main.py
# https://github.com/jiangtaoxie/fast-MPN-COV/blob/c430c781264b7ce77536493308b09d73d534ce7a/model_init.py#L58
# https://github.com/jiangtaoxie/fast-MPN-COV/blob/c430c781264b7ce77536493308b09d73d534ce7a/src/network/base.py
# https://github.com/jiangtaoxie/fast-MPN-COV/blob/c430c781264b7ce77536493308b09d73d534ce7a/src/network/mpncovvgg.py#L16
# https://github.com/jiangtaoxie/fast-MPN-COV/blob/c430c781264b7ce77536493308b09d73d534ce7a/src/representation/MPNCOV.py
'''
import torch
...
class MPNCOV(nn.Module):
     ...
     Args:
         iterNum: #iteration of Newton-schulz method (5 by def in vgg and resnet)
         https://github.com/jiangtaoxie/fast-MPN-COV/blob/c430c781264b7ce77536493308b09d73d534ce7a/src/network/mpncovvgg.py#L16
         https://github.com/jiangtaoxie/fast-MPN-COV/blob/c430c781264b7ce77536493308b09d73d534ce7a/src/network/mpncovresnet.py#L77
     ...
     """
     def __init__(self, iterNum=5, is_sqrt=True, is_vec=True, input_dim=2048, dimension_reduction=None):
...
class Sqrtm(Function):
     ...
     def backward(ctx, grad_output):
         ...
         der_postCom = (grad_output*torch.sqrt(normA).view(batchSize, 1, 1).expand_as(x)).type(dtype)
         der_postComAux = ((grad_output*ZY).sum(dim=1).sum(dim=1).div(2*torch.sqrt(normA))).type(dtype)
         I3 = 3.0*torch.eye(dim,dim,device = x.device).view(1, dim, dim).repeat(batchSize,1,1).type(dtype)
         if iterN < 2:
            ...
            der_NSiter = 0.5*(dldY.bmm(I3 - A.type(dtype)) - dldZ - A.type(dtype).bmm(dldY))
